...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000314u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x008Fu);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0 + 0x2u), 0x18u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x3725u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x42u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP0_SW0, 0x24u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP1_MX, 0x0101u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP2_MX, 0x01080106u);
...
uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_A__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_1_CYAMUXSIDE_A__maskTable[2] = {
	0x02u, 
	0x08u, 
};
...
uint8 CYXDATA * const CYCODE AMux_1_CYAMUXSIDE_B__addrTable[4] = {
	...
	(uint8 CYXDATA *)CYREG_PRT2_AG, (uint8 CYXDATA *)CYREG_DSM0_SW4, 
};
